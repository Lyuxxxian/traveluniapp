...
- 当前状态：首页、地图、商城、我的、发现等主导航页面已完成静态界面；多数点击后的功能页和接口尚未开发。
...
1. 新增 API 请求封装：统一 baseURL、token、错误提示。
2. 用户资料接口：获取昵称、头像、游客 ID，支持头像昵称编辑页接入。
3. 商城商品接口：商城首页、商品列表、商品详情。
4. 订单接口：创建订单、订单列表、订单详情、模拟支付。
5. 优惠券接口：领券中心、我的优惠券。
6. 购物车接口：加入购物车、购物车列表、数量修改、删除。
