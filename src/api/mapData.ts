...
export const MAP_ROUTES = [
  {
    ...
    scene: 'culture',
    durationText: '约3小时',
    pointIds: [107, 108, 109, 101, 104, 106],
    desc: '适合对历史、佛教文化、建筑艺术感兴趣的游客，重点讲大照壁、祥符禅寺、大佛、梵宫与坛城。',
  },
  {
    id: 2,
    title: '亲子家庭轻松游',
    scene: 'family',
    durationText: '约2.5小时',
    pointIds: [103, 108, 114, 104, 106],
    desc: '适合带孩子轻松游，串联动态表演、互动拍照、梵宫艺术和转经体验，减少高强度步行。',
  },
  {
    id: 3,
    title: '自然风光拍照游',
    scene: 'nature',
    durationText: '约2.5小时',
    pointIds: [110, 103, 111, 101, 112, 113, 104],
  ...
  },
  {
    ...
    scene: 'relax',
    durationText: '约2小时',
    pointIds: [107, 102, 110, 111, 113, 104],
